...
class DashboardController extends Controller
{
    ...
    public function index()
    {
        ...
        $void = Orders::where('status', '=', 'VOID')->count();
        $paid = Orders::where('status', '=', 'PAID')->count();
        $pending = Orders::where('status', '=', 'PENDING')->count();
        $notApproved = Orders::where('status', '=', 'NOT_APPROVED')->count();
        $proccesed = Orders::where('status', '=', 'PROCESSED')->count();
        $ongoing = Orders::where('status', '=', 'ONGOING')->count();
        $sending = Orders::where('status', '=', 'SEND')->count();
        $accepted = Orders::where('status', '=', 'ACCEPTED')->count();
        $complain = Orders::where('status', '=', 'COMPLAINT')->count();
